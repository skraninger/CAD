    ...
    difference() {
        ...
        if (cutout) {
            ...
            translate([ph_hole_center_offset, hb_depth/2,
                b_height-s_height-wall_thickness+switch_indent])
                    rotate([180,0,0])
                        cylinder(switch_indent,d=switch_top_diam);
        }
    }
}
